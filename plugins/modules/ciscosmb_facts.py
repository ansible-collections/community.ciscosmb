#!/usr/bin/python
#
# Ansible Galaxy module for Cisco SMB switches
#
...
__metaclass__ = type
DOCUMENTATION = """
module: cisosmb_facts
author:
- Petr Klima (@qaxi)
short_description: Collect facts from remote Cisco SMB switches - SG300, SG500, SG350, SG550 
description:
- Collects a base set of device facts from a remote Cisco SMB switches 
  SG300, SG500, SG350, SG550 - that are not running IOS.  This
...
notes:
- Tested against firmware - SG300 v.1.4.6, SG500, SG350, SG550
options:
  gather_subset:
    description:
...
from ansible_collections.qaxi.ciscosmb.plugins.module_utils.network.ciscosmb.argspec.facts.facts import (
    FactsArgs,
)
