...
from ansible_collections.qaxi.ciscosmb.plugins.modules import ciscosmb_facts
...
class TestCiscoSMBFactsModuleOnSG550X24MPK9(TestCiscoSMBModule):
    ...
    def setUp(self):
        super().setUp()
        self.mock_run_commands = patch('ansible_collections.qaxi.ciscosmb.plugins.modules.ciscosmb_facts.run_commands')
    ...
    def load_fixtures(self, commands=None):
        def load_from_file(*args, **kwargs):
            ...
            for command in commands:
                ...
                output.append(load_fixture('ciscosmb_facts-%s-SG550X-24MP-K9' % filename))
            return output
