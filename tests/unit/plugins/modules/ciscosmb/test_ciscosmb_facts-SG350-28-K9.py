...
class TestCiscoSMBFactsModule(TestCiscoSMBModule):
    ...
    def test_ciscosmb_facts_default(self):
        ...
        self.assertEqual(result["ansible_facts"]["ansible_net_boot_version"], None)
        self.assertEqual(result["ansible_facts"]["ansible_net_hw_version"], "V01")
        self.assertEqual(result["ansible_facts"]["ansible_net_uptime"], 890845)
        self.assertEqual(
        ...
        self.assertEqual(result["ansible_facts"]["ansible_net_model"], "SG350-28-K9")
        self.assertEqual(
